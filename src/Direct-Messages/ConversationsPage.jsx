...
function ConversationsPage({ selectedTag, setSelectedTag }) {
  const [searchValue, setSearchValue] = useState('');
  const [mode, setMode] = useState(false);

  return (
    <div className="flex h-screen w-full min-w-[388px] flex-col border-l-[1px] border-[#f6f8f9] dark:border-[#252829] dark:bg-black dark:text-white">
      <Header
        title="Messages"
