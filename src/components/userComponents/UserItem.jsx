...
function UserItem({
  ...
  return (
    <div className="relative h-min w-full cursor-pointer px-4 py-3 hover:bg-[#080808]">
          ...
          <div className="flex w-full flex-row items-center justify-between">
            ...
            <div>
              ...
              >
                <Button
                  backGroundColor={
                    isFollowed ? (isButtonHovered ? 'red' : 'white') : 'white'
                  }
                  backGroundColorDark={
                    isFollowed ? (isButtonHovered ? 'red' : 'black') : 'black'
                  }
                  borderColor={
                    isFollowed ? (isButtonHovered ? 'red' : 'gray') : 'gray'
                  }
                  label={
                    isFollowed
                      ? isButtonHovered
