...
function LogoutConfirm() {
  ...
  return (
    ...
    >
      ...
      border-[1px] border-light-gray bg-white py-8 text-lg 
      text-black dark:border-none dark:bg-pure-black dark:text-white"
      >
        ...
        <div className="items- flex h-full w-full flex-col justify-start gap-5 px-8 py-3">
