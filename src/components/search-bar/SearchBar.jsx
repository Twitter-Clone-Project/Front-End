        ...
        <div className="relative w-full">
          <div
            ...
            className={`flex h-[42px] w-full items-center bg-[#f7f8f8] dark:bg-[#16181c] ${
              focus === true
                ? 'justify-between border-2 border-blue border-opacity-100 dark:bg-pure-black'
                : ''
            } rounded-full bg-[#f7f8f8] py-2 pl-2 pr-2`}
            data-testid="search-bar-field"
          >
            <div className="w-1/12 pr-1 sm:pr-0">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div className={`${focus === true ? 'w-11/12' : 'w-10/12'}`}>
              <input
                // eslint-disable-next-line max-len
                className={`w-full border-none bg-[#f7f8f8] pl-2 placeholder-light-gray focus:outline-none dark:bg-[#16181c] sm:pl-0 ${
